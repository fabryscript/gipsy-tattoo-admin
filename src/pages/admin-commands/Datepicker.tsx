...
const DAY_NAMES_DEFAULT = ["Dom", "Lun", "Mar", "Mer", "Gio", "Ven", "Sab"];
const DATE_FORMAT_DEFAULT = "dd/MM/yyy";
...
const SingleDatepickerCalendar = (
  props: RenderProps & { configs: SingleDatepickerConfigs } & { color: string }
) => {
  const {
    calendars,
    getDateProps,
...
export const DayzedPicker: React.FC<SingleDatepickerProps> = ({
  configs = {
  ...
  const { date, name, disabled, onDateChange, id, color } = props;
    ...
    >
      ...
      <PopoverContent ref={ref}>
        <PopoverBody
          ...
          borderColor={color}
        >
          <SingleDatepickerCalendar {...dayzedData} configs={configs} color={color!} />
        </PopoverBody>
      </PopoverContent>
    </Popover>
  );
